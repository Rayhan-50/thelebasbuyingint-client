...
//                 <p className="text-[#D0A96A] text-xs sm:text-sm font-medium">THELEBASBUYINGINT</p>
//               </div>
//             </div>
            ...
            <nav className="space-y-2 sm:space-y-3">
              ...
              {user && isAdmin && (
                <>
                  ...
                  {renderNavLink("/dashboard/showContact", <MessageSquare className="h-4 w-4 sm:h-5 sm:w-5" />, "Show Contact Data")}
                   {renderNavLink("/dashboard/AddCategoryForm", <MessageSquare className="h-4 w-4 sm:h-5 sm:w-5" />, "Add Category Form")}
                    {renderNavLink("/dashboard/ShowCategoryFormData", <MessageSquare className="h-4 w-4 sm:h-5 sm:w-5" />, "Add Category Form")}
                </>
              )}
            </nav>
          </div>
