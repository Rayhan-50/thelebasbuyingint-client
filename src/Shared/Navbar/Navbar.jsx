...
//     { name: 'Production', href: '/production', isExternal: false },
...
//                     className="text-white font-host-grotesk hover:text-mint-green transition-colors duration-300 px-3 py-2 text-sm font-medium relative group"
//                   >
//                     {item.name}
