              ...
              <div className="space-y-8">
                ...
                <div className="bg-white rounded-3xl p-8 shadow-2xl">
                  ...
                  <div className="rounded-2xl overflow-hidden shadow-lg">
                    <iframe
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3651.902288548726!2d90.365421315431!3d23.806451784566!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755c13f0f0f0f0f%3A0x0!2sMirpur%2C%20Dhaka%2C%20Bangladesh!5e0!3m2!1sen!2sbd!4v1634567890123!5m2!1sen!2sbd"
                      width="100%"
                      height="400"
                      style={{ border: 0 }}
                      allowFullScreen=""
                      ...
                      title="The Lebas Buying Location - Mirpur, Dhaka, Bangladesh"
                    ...
                    <div className="bg-gradient-to-r from-deep-teal to-mint-green rounded-xl p-4 mb-4">
                      <div className="flex items-center justify-center gap-3 text-white">
                        ...
                        <div className="text-left">
                          <p className="font-semibold font-space-grotesk">House #123, Road #7</p>
                          <p className="text-sm font-dm-sans">Mirpur-10, Dhaka-1216, Bangladesh</p>
                        </div>
                      </div>
                    </div>
                    <a
                      href="https://maps.google.com/?q=Mirpur+10,+Dhaka,+Bangladesh"
                      target="_blank"
                      rel="noopener noreferrer"
